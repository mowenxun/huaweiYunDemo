...
/**
 * @ClassName SaleOutTaskInfoResponseDTO
 * @Description TODO
 * @Author SongTao
 * @Date 2020-07-21
 * @Version 1.0
...
public class SaleOutTaskInfoResponseDTO extends AbstractTenantDTO implements Serializable {
    private static final long serialVersionUID = -3394152070014076706L;
    /**
     * 订单ID
     */
