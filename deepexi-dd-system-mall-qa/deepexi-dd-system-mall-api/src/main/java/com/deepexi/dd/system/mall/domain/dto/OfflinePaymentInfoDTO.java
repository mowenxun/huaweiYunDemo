...
/**
 * @ClassName OfflinePaymentInfoDTO
 * @Description 线下付款信息
 * @Author SongTao
 * @Date 2020-07-27
 * @Version 1.0
...
@ApiModel(description = "OfflinePaymentInfoDTO")
public class OfflinePaymentInfoDTO extends AbstractObject implements Serializable {
    private static final long serialVersionUID = -4081554241109094664L;
