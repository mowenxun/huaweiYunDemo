package com.deepexi.dd.system.mall.domain.dto.order;
 ...
 * @author yp
 * @version 1.0
 * @date 2020-08-26 14:41
 */
@Data
@EqualsAndHashCode(callSuper = false)
@ApiModel(description = "订单自提地址添加对象")
public class OrderSelfRaisingInfoAddRequestDTO extends AbstractObject implements Serializable {
    ...
    @ApiModelProperty(value = "提货仓库Id")
    private Long deliveryWareHouseName;
}
