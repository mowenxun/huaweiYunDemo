...
import com.deepexi.util.FileUtils;
...
public class MultipartFileUtils {
    ...
    public static File copyMultipartFile2File(MultipartFile multipartFile) throws IOException {
        return FileUtils.createTmpFile(multipartFile.getInputStream(),multipartFile.getName(), getFileType(multipartFile));
    }
    ...
    public static String getFileType(MultipartFile file) {
        ...
        try {
            filetype = getFileTypeByStream(file.getBytes());
