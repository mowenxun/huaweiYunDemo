 ...
 * @Author: mumu
 * @Description: todo
 * @Datetime: 2020/9/13   17:56
 * @version: v1.0
 */
@Data
@EqualsAndHashCode(callSuper = false)
@ApiModel(description = "app 销售单")
public class AppSaleOrderResponseDTO extends AbstractObject implements Serializable {
    ...
    private List<SaleOutTaskDetailResponseDTO> saleOutTaskList;
