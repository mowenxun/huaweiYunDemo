...
public class OrderRefundReasonResponseDTO extends AbstractObject implements Serializable {
    ...
    private List<OrderRefundSkuResponseDTO> refundSku;

    /**
     * 退款操作记录
     */
    @ApiModelProperty(value = "退款操作记录")
    private List<OrderOperationRecordResponseDTO> orderOperationRecordResponseList;
}
