...
@ApiModel(description = "SaleCloudInterfaceRecordResponseDTO")
public class SaleCloudInterfaceRecordResponseDTO extends AbstractObject implements Serializable {
