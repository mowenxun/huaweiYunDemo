...
/**
* OrderDeliverySelfRaisingInfoQuery
*
* @author admin
...
@ApiModel(description = "OrderDeliverySelfRaisingInfoRequestQuery")
public class OrderDeliverySelfRaisingInfoRequestQuery extends AbstractObject implements Serializable {
