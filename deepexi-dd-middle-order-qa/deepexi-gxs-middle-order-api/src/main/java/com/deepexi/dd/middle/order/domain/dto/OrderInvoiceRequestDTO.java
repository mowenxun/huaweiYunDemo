...
@ApiModel(description = "OrderInvoiceRequestDTO")
public class OrderInvoiceRequestDTO extends AbstractObject implements Serializable {
...
private static final long serialVersionUID = 1L;
   ...
   // @NotNull(message = "纳税人识别号（税号）不能为空")
