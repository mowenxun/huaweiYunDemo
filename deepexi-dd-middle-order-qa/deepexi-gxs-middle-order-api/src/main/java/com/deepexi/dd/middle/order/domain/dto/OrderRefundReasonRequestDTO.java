...
public class OrderRefundReasonRequestDTO extends AbstractObject implements Serializable {
    ...
    /**
     * 退款状态：24待确认,30退款成功,5已驳回,33取消退款
     */
    @ApiModelProperty(value = "退款状态：24待确认,30退款成功,5已驳回,33取消退款")
    ...
    private List<OrderRefundSkuRequestDTO> refundSku;
    ...
    /**
     * 修改退款单状态: 成功: true , 驳回: false
     */
    @ApiModelProperty(value = "成功: true , 驳回: false")
