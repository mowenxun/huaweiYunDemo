...
@ApiModel(description = "SaleDeliveryGoodsPlanRulesRequestQuery")
public class SaleDeliveryGoodsPlanRulesRequestQuery extends AbstractObject implements Serializable {
