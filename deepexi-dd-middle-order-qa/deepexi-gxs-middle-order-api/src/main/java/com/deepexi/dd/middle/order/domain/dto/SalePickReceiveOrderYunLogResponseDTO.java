...
@ApiModel(description = "SalePickReceiveOrderYunLogResponseDTO")
public class SalePickReceiveOrderYunLogResponseDTO extends AbstractObject implements Serializable {
