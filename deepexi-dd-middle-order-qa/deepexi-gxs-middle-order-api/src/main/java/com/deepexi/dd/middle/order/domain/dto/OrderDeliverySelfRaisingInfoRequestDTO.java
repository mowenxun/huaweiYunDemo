...
@ApiModel(description = "OrderDeliverySelfRaisingInfoRequestDTO")
public class OrderDeliverySelfRaisingInfoRequestDTO extends AbstractObject implements Serializable {
