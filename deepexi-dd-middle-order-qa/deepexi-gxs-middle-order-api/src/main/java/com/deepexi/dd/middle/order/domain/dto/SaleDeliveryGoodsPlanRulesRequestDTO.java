...
@ApiModel(description = "SaleDeliveryGoodsPlanRulesRequestDTO")
public class SaleDeliveryGoodsPlanRulesRequestDTO extends AbstractObject implements Serializable {
