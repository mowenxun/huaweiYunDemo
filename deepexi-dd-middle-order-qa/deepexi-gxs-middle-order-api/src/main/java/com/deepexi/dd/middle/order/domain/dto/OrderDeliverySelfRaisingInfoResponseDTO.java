...
@ApiModel(description = "OrderDeliverySelfRaisingInfoResponseDTO")
public class OrderDeliverySelfRaisingInfoResponseDTO extends AbstractObject implements Serializable {
