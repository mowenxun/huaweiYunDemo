 ...
 * @date 2020/10/13
 */
@RequestMapping("/open-api/v1/domain/gxs/supplier/order")
@Api(value = "SupplierOrderApi", tags = "供销社-供应商端-订单管理")
public interface SupplierOrderDomainApi {
    ...
    SupplierOrderDetailResponseDTO orderDetailsByCode(@PathVariable("code") String code);
}
