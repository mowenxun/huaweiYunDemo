...
public class SalePickGoodsInfoResponseDTO extends AbstractObject implements Serializable {
...
private static final long serialVersionUID = 1L;
    ...
    */
     ...
     * 提货单商品总签收数
     */
    @ApiModelProperty(value = "提货单商品总签收数")
    ...
    */
    ...
    /**
     * 提货单所关联所有sku的图片，目前用于在线订购提货列表
     */
    @ApiModelProperty(value = "提货单所关联所有sku的图片")
    private List<String> majorPictureList;
    /**
     * 操作按钮
     */
