...
/**
 * @ClassName OfflineCollectionInfoDTO
 * @Description 收款信息
 * @Author SongTao
 * @Date 2020-07-27
 * @Version 1.0
...
public class OfflineCollectionInfoDTO extends AbstractObject implements Serializable {
    private static final long serialVersionUID = -4547041839853634549L;
