 ...
 * @date 2020/10/14
 */
@RequestMapping("/open-api/v1/domain/gxs/supplier/financial")
@Api(value = "SupplierFinancialApi", tags = "供销社-供应商端-财务管理api")
public interface SupplierFinancialDomainApi {
