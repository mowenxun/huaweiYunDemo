...
@ApiModel
public class SupplierOrderDetailDTO extends AbstractObject implements Serializable {
    ...
    @Data
    @ApiModel("SupplierOrderDetailDTOInvoice")
    ...
    @Data
    @ApiModel("SupplierOrderDetailDTOConsigneeAddress")
