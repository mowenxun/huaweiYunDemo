...
@ApiModel(description = "SalePickGoodsOrderRespDTO")
public class SalePickGoodsOrderRespDTO extends AbstractObject implements Serializable {
...
private static final long serialVersionUID = 1L;
    ...
    */
    ...
    private List<com.deepexi.dd.domain.transaction.domain.dto.SalePickGoodsOrderSkuRespDTO> items;
