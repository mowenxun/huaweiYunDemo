...
@ApiModel(description = "OrderDeliverySelfRaisingInfoRespDTO")
public class OrderDeliverySelfRaisingInfoRespDTO extends AbstractObject implements Serializable {
