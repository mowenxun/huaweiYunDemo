...
@ApiModel(description = "OrderDeliverySelfRaisingInfoReqQuery")
public class OrderDeliverySelfRaisingInfoReqQuery extends AbstractObject implements Serializable {
