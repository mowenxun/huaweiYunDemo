package com.deepexi.dd.domain.transaction.domain.dto.payOrder;
...
@ApiModel(description = "PayOrderInfoDTO")
public class PayOrderInfoDTO extends AbstractDTO implements Serializable {
