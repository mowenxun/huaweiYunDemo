...
public class PlatformShopOrderDomainResponseDTO extends AbstractObject implements Serializable {
...
private static final long serialVersionUID = 1L;
    ...
    */
    ...
    @ApiModelProperty(value = "店铺订单和已分发订单的关系")
    private ShopSupplerRelationResponseDTO shopSupplerRelationResponseDTO;
